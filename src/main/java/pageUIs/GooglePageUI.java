...
public class GooglePageUI {
    ...
    //Search result
//    public static final String GOOGLE_SEARCH_RESULTS = "//div[@class='g']//h3";
    ...
    public static final String GOOGLE_VIDEOS_RESULTS = "//h3[text()='Videos']/parent::div/following-sibling::div//a/div/div[@aria-level='3']";
}
